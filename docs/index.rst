...
TRACKELEC a pour objectif de prédire la consommation d'électricité au jour du 8 décembre 2022 et de fournir une carte intéractive de la France présentant la cosommation annuelle moyenne d'électricité entre 2018 et 2021.
...
Le code correspondant à cette partie ce nomme ``bbbb`` et vous pouvez retrouver sa documentation dans la partie 

...
data = cons.loc[
    ["2021-12-08", "2020-12-08", "2019-12-08", "2018-12-08", "2017-12-08"
...
data1 = pd.read_csv("consommation_2022.csv", delimiter=";", comment="#",
                    na_values="n/d", parse_dates=['Date'],
...
model2 = Prophet()
model2.fit(df3)
f2 = model2.make_future_dataframe(periods=48 * 10, freq='30min',
...
model1 = Prophet()
model1.fit(df2)
f = model1.make_future_dataframe(periods=48 * 10, freq='30min',
                                 include_history=False)
...
model3 = Prophet()
model3.fit(df4)
f3 = model3.make_future_dataframe(periods=48 * 10, freq='30min',
                                  include_history=False)
...
model4 = Prophet()
model4.fit(df5)
f4 = model4.make_future_dataframe(periods=48 * 10, freq='30min',
                                  include_history=False)
